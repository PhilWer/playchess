...
class DepthImageProcessing:
    ...
    def plane_model(self):
        ...
        #                             'depth_array_for_plane_model.csv'),delimiter=",")
        depth_array = np.genfromtxt('/home/vaishakh/tiago_public_ws/src/playchess/config/tmp/depth/depth_array_for_plane_model.csv',delimiter=",")
        # Load image from png
        # rgb_img = cv2.imread(os.path.join(root, 'config', 'tmp', 'rgb', 
        #                       'rgb_image_for_plane_model.png'))
        rgb_image = cv2.imread('/home/vaishakh/tiago_public_ws/src/playchess/config/tmp/rgb/rgb_image_for_plane_model.png')
        ...
        pcl = self.depth_to_point_cloud(depth_array, rgb_image, filter_points)
    ...
    def neglect_pcd_above_and_below_certain_height(self, pcd_o3d):
        ...
        ######################################################
        if len(np.asarray(pcd_o3d.points)) < 100000000:
    ...
    def depth_pcl_counting(self, depth_image, rgb_image, filter_points, quat=[-0.673, 0.679, -0.202, 0.214], trans=[0.232, 0.016, 1.318]):
...
if __name__ == '__main__':
    ...
    with open(r'/home/vaishakh/tiago_public_ws/src/playchess__/playchess/scripts/vaishakh_scripts/image_processing/yaml/corners_names_empty_square.yaml', 'r') as file:
        ...
        for i in chessboard_square_corners:
                ...
                filter_points = np.array([(215, 91), (509, 110), (562, 405), (130, 369)]) #for full chess_board
                depth_image = np.genfromtxt(
                    '/home/vaishakh/tiago_public_ws/src/playchess__/playchess/scripts/vaishakh_scripts/image_processing/move_detection/csv/Special_moves_test_opponent_black/casteling/casteling_king_side/before/empty_depth_image.csv', delimiter=',')
                rgb_image = cv2.imread(
                    '/home/vaishakh/tiago_public_ws/src/playchess__/playchess/scripts/vaishakh_scripts/image_processing/move_detection/csv/Special_moves_test_opponent_black/casteling/casteling_king_side/before/empty_rgb_image.png')
