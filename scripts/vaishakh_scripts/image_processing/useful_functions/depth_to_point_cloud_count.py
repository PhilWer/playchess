...
if __name__ == '__main__':
    ...
    depth_image = np.genfromtxt(
        '/home/pal/tiago_public_ws/src/playchess/scripts/vaishakh_scripts/image_processing/move_detection/csv/move_2/empty_depth_image.csv', delimiter=',')
    with open(r'/home/pal/tiago_public_ws/src/playchess/scripts/vaishakh_scripts/image_processing/yaml/corners_names_empty_square.yaml', 'r') as file:
    ...
    depth_image = np.genfromtxt('/home/pal/tiago_public_ws/src/playchess/scripts/vaishakh_scripts/image_processing/move_detection/csv/move_4/empty_depth_image.csv', delimiter=',')
    rgb_image=cv2.imread('/home/pal/tiago_public_ws/src/playchess/scripts/vaishakh_scripts/image_processing/move_detection/csv/move_4/empty_rgb_image.png')
