...
# Defines
# /root/tiago_public_ws/src/tiago_playchess/pcl_depth_synchro/03/rgb03.png
imported_rgb_image = '/home/vaishakh/tiago_public_ws/src/playchess/scripts/vaishakh_scripts/image_processing/move_detection/csv/random_ordered_board/rgb_image.png'
# /root/tiago_public_ws/src/tiago_playchess/pcl_depth_synchro/03/depth_norm03.png
imported_depth_image = '/home/vaishakh/tiago_public_ws/src/playchess/scripts/vaishakh_scripts/image_processing/move_detection/csv/random_ordered_board/depth_image.png'
# /root/tiago_public_ws/src/tiago_playchess/pcl_depth_synchro/03/depth03.csv
imported_depth_image_csv = '/home/vaishakh/tiago_public_ws/src/playchess/scripts/vaishakh_scripts/image_processing/depth_image.csv'
...
# /root/tiago_public_ws/src/tiago_playchess/pcl_depth_synchro/03/prova_cm.png
imported_depth_img_raw = '/home/vaishakh/tiago_public_ws/src/playchess/scripts/vaishakh_scripts/image_processing/move_detection/csv/random_ordered_board/depth_image.png'
# /root/tiago_public_ws/src/tiago_playchess/config/simul_config_not_transformed.yaml
imported_chessboard_squares = r'/home/vaishakh/tiago_public_ws/src/playchess/scripts/config/simulation_config.yaml'
...
class DepthProcessing:
    ...
    def __init__(self):
        ...
        self.depth_image = o3d.io.read_image(
            imported_depth_img_raw)  # imported_depth_image)
    ...
    def pcl_creation(self, rgb_image, depth_image):
        rot_matrix = self.quaternion_rotation_matrix(
            self.rotation_in_quaternions)
        immagine = o3d.geometry.Image(np.array(np.asarray(rgb_image)[:, :, :3]).astype(
            'uint8'))  # Create the Image geometry element
        rgbd_image = o3d.geometry.RGBDImage.create_from_color_and_depth(
            immagine, depth_image, convert_rgb_to_intensity=True, depth_scale=0.01)

        # Extrinsic matrix creation
        extrinsic = np.array([[rot_matrix[0][0], rot_matrix[0][1], rot_matrix[0][2], self.translation[0]], [rot_matrix[1][0], rot_matrix[1][1],
                             rot_matrix[1][2], self.translation[1]], [rot_matrix[2][0], rot_matrix[2][1], rot_matrix[2][2], self.translation[2]], [0, 0, 0, 1]])
        # Set the intrinsic parameters of the camera.
        phc = o3d.camera.PinholeCameraIntrinsic()
        phc.set_intrinsics(self.width, self.height,
                           self.K[0], self.K[4], self.K[2], self.K[5])
        ...
        pcd = o3d.geometry.PointCloud.create_from_rgbd_image(
            rgbd_image, phc, extrinsic, project_valid_depth_only=True)
        o3d.visualization.draw_geometries(
            [pcd], zoom=1000, front=[0, 0, -1], lookat=[0, 0, 1], up=[0, -1, 0])
...
def main():
    ...
    xyz = depth_processor.uvz_to_xyz(
        depth_processor.pts[:, :2], depth_processor.pts[:, -1], depth_processor.K)
    pcd_red = o3d.geometry.PointCloud()
    pcd_red.points = o3d.utility.Vector3dVector(xyz)
